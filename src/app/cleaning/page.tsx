...
export default function CleaningPage() {
  ...
  const handleDiscardLead = (id: string) => {
    setLeads((prev) =>
      prev.map((l) => (l.id === id ? { ...l, grade: 'D' as const, matchScore: 20 } : l))
    );
  };
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-900/80 p-6 rounded-2xl border border-slate-800">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-cyan-500 text-slate-950 font-bold text-xs hover:bg-cyan-400 flex items-center space-x-2 transition-colors shadow-lg shadow-cyan-500/20"
        >
